...
HD_PWD='E:/Modelsim_Vivado/lab5_combination/vivado/ModeComparation/ModeComparation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ModeComparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ModeComparator.tcl -notrace
