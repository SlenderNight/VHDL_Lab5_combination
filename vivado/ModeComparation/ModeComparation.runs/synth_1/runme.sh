...
HD_PWD='E:/Modelsim_Vivado/lab5_combination/vivado/ModeComparation/ModeComparation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModeComparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModeComparator.tcl
